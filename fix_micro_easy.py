...
# 提取QUESTION_BANK的开始和结束
qb_start = content.find('QUESTION_BANK = {')
qb_list_start = content.find('{', qb_start)
qb_list_end = find_matching_bracket(content, qb_list_start)
qb_str = content[qb_list_start:qb_list_end+1]

question_bank = ast.literal_eval(qb_str)
...
# 重新生成QUESTION_BANK
import pprint
new_qb_str = 'QUESTION_BANK = ' + pprint.pformat(question_bank, width=1000000)

# 更新app.py
new_content = content[:qb_start] + new_qb_str + content[qb_list_end+1:]
