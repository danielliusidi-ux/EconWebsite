...
ap_macro_list_start = content.find('[', ap_macro_start)
ap_macro_list_end = find_matching_bracket(content, ap_macro_list_start)
ap_macro_str = content[ap_macro_list_start:ap_macro_list_end+1]
...
# 更新app.py
new_ap_micro_str = repr(questions)
new_content = content[:list_start] + new_ap_micro_str + ",\n    'ap_macro': " + ap_macro_str + "\n}"
